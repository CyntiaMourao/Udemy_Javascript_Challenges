...
console.log(game.scored.entries()); // o método "entries" usa-se com arrays
console.log(Object.entries(game.odds)); // transforma o objecto em array
